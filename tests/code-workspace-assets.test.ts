...
describe('Mini App imported-code workspace and fixture fallback assets', () => {
  it('loads the new code editor, schedule labels and original four navigation tabs', () => {
    ...
    expect(html).toContain('/app/code-analysis.js?v=5.4.0');
    expect(html).toContain('/app/watch-sync.js?v=5.3.0');
    expect(code).toContain("import './code-workspace.js?v=5.4.0'");
